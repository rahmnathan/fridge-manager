node {
    ...
    stage('Checkout') {
        git 'https://github.com/rahmnathan/fridge-manager.git'
    }
    stage('Set Version') {
        PROJECT_VERSION = sh(
    ...
    stage('Deploy to Kubernetes') {
        withCredentials([
            ...
            sh 'helm upgrade fridge-manager ./target/classes/fridge-manager/ --set fridge.vaultToken=$VAULT_TOKEN --kubeconfig $KUBE_CONFIG'
        }
    }
}